...
#+BEGIN_SRC yasnippet :tangle ./ss-sign
# name: scriptsize_simbol
# key: sss
# contributor:yeiipi
# group : math
# type: command
# --
(if (region-active-p)
(yas-expand-snippet "\\scriptsize\{ `yas-selected-text` \}$0")
(yas-expand-snippet "\\scriptsize\{ $1 \}$0"))
#+END_SRC
...
#+BEGIN_SRC yasnippet :tangle ./new-snip-org
# name: new_snip_org
# key: nso
# contributor:yeiipi
# group : snipps
# --
#+BEGIN_SRC yasnippet :tangle ${2:./${1:$(string-for-latex-labels yas-text)}}
# -*- mode: snippet -*-
# name: $1
# key: ${3:snipp_key}
# contributor:yeiipi
