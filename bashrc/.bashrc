...
export PATH=$HOME/.emacs.d/bin:$PATH:$HOME/go/bin:/home/jpi/programs/julia-1.6.2/bin

alias data='cd /media/Data/'
alias ur='cd /media/Data/Universidad/'
alias musica='cd /media/Data/Musica/'
alias sdn='shutDOWN;shutdown now'
alias rbn='shutDOWN;shutdown -r now'
alias ll='ls -alF'
alias la='ls -A'
alias l='ls -CF'
...
alias obsidian="~/programs/Obsidian.AppImage & disown"
alias kr="ibus-setup & disown"
alias matlab="/usr/local/MATLAB/R2021a/bin/matlab & disown"
alias mendeley="mendeleydesktop & disown"
alias kkdiscord="pkill -KILL Discord"
alias kkzoom="pkill -KILL zoom"
alias kkfirefox="pkill -KILL firefox"
alias kkchrome="pkill -KILL chrome"
alias kkk="kkdiscord ; kkzoom ; kkfirefox ; kkchrome"
